...
const View_Data = ()=>{
   ...
   const [alert,setAlert]  = useState('')
     ...
     function  getData() { 
         axios.get('https://65fc97a69fc4425c65307aa4.mockapi.io/students').then((res)=>{
  ...
  // delHandler
   ...
   const delHandler =(id)=>{
     axios.delete(`https://65fc97a69fc4425c65307aa4.mockapi.io/students/${id}`).then(()=>{
         getData()
    ...
    // updateHandler  
     ...
     const updateHandler = (id)=>{
        ...
        axios.get(`https://65fc97a69fc4425c65307aa4.mockapi.io/students/${id}`).then((res)=>{
           console.log(res);
           setID(id)
